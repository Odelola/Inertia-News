...
const SearchHeader = () => {
  ...
  return (
    <div className="news-search lg:max-w-lg md:w-96 sm:bg-red h-12 mx-auto border-[#EFF0F7] border-solid border-2 rounded-full my-6 relative flex justify-between pr-2">
